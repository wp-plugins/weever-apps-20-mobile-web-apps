describe('FacebookEvents SubTab', function() {
    beforeEach(function() {
        var model = new wxApp.FacebookEventsSubTab();
        this.model = model;
	...
	it('should have default title of Facebook', function() {
		expect( this.model.get('title') ).toEqual('Events');
	});

    it('should have default content of Facebook', function() {
        expect( this.model.get('content') ).toEqual('facebookEvents');
    });
